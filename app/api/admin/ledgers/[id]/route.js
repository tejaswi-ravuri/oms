...
export async function PUT(request, context) {
  try {
    ...
    if (body.contact_person_name !== undefined)
      updateData.contact_person_name = body.contact_person_name?.trim() || null;
    if (body.mobile_number !== undefined)
      updateData.mobile_number = body.mobile_number?.trim() || null;
    ...
    if (body.zip_code !== undefined)
      updateData.zip_code = body.zip_code?.trim() || null;
    if (body.gst_number !== undefined)
      updateData.gst_number =
        body.gst_number?.replace(/\s/g, "").toUpperCase() || null;
    if (body.pan_number !== undefined)
      updateData.pan_number =
        body.pan_number?.replace(/\s/g, "").toUpperCase() || null;
    if (body.business_logo !== undefined)
      updateData.business_logo = body.business_logo || null;
