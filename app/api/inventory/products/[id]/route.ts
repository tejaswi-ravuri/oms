...
export async function PUT(
  ...
  try {
    ...
    const allowedFields = [
      "product_name", "product_sku", "product_category", "product_sub_category",
      "product_size", "product_color", "product_description", "product_material",
      "product_brand", "product_country", "product_status", "product_qty",
      "wash_care", "manufacturing_cost", "refurbished_cost", "is_refurbished",
