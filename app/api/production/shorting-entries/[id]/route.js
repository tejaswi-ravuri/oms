...
export async function PUT(request, context) {
  try {
    ...
    if (body.weaver_challan_id !== undefined)
      cleanedData.weaver_challan_id = body.weaver_challan_id || null;
    ...
    if (body.total_pieces !== undefined) {
      cleanedData.total_pieces = body.total_pieces
        ? parseInt(String(body.total_pieces))
        : 0;
    }
    if (body.good_pieces !== undefined) {
      cleanedData.good_pieces = body.good_pieces
        ? parseInt(String(body.good_pieces))
        : 0;
    }
    if (body.damaged_pieces !== undefined) {
      cleanedData.damaged_pieces = body.damaged_pieces
        ? parseInt(String(body.damaged_pieces))
        : 0;
    }
    if (body.rejected_pieces !== undefined) {
      cleanedData.rejected_pieces = body.rejected_pieces
