...
export async function PUT(
  ...
  try {
    ...
    if (body.weaver_ledger_id !== undefined) cleanedData.weaver_ledger_id = body.weaver_ledger_id;
    ...
    if (body.ms_party_name !== undefined) cleanedData.ms_party_name = body.ms_party_name || null;
    
    // Handle numeric fields properly
    if (body.quantity_sent_meters !== undefined) {
      cleanedData.quantity_sent_meters = body.quantity_sent_meters ? parseFloat(String(body.quantity_sent_meters)) : 0;
    }
    if (body.quantity_received_meters !== undefined) {
      cleanedData.quantity_received_meters = body.quantity_received_meters ? parseFloat(String(body.quantity_received_meters)) : 0;
    }
    if (body.rate_per_meter !== undefined) {
      cleanedData.rate_per_meter = body.rate_per_meter ? parseFloat(String(body.rate_per_meter)) : null;
    }
    if (body.vendor_amount !== undefined) {
      cleanedData.vendor_amount = body.vendor_amount ? parseFloat(String(body.vendor_amount)) : null;
    }
    ...
    if (body.total_grey_mtr !== undefined) {
      cleanedData.total_grey_mtr = body.total_grey_mtr ? parseFloat(String(body.total_grey_mtr)) : null;
    }
