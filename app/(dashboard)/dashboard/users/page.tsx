...
type UserFormData = Partial<Omit<User, "id" | "created_at" | "updated_at">> & {
  id?: string;
};
...
export default function UsersPage() {
    ...
    try {
      if (editingUser && editingUser.id) {
        ...
        const updateData: Partial<User> = {
          ...
          user_role: userData.user_role as User["user_role"],
          user_status: userData.user_status as User["user_status"],
  ...
  const getDefaultProfileImage = (firstName: string, lastName: string) => {
