    ...
    try {
      ...
      if (productsResponse.ok) {
        ...
        const totalValue = products.reduce(
          (sum, p) => sum + p.selling_price * (p.product_qty || 0),
          0
        );
        ...
        setAnalytics({
          ...
          activeProducts: products.filter((p) => p.product_status === "Active")
            .length,
          ...
          totalValue,
          totalQuantity,
          lowStockProducts: products.filter((p) => (p.product_qty || 0) < 10)
            .length,
          categories,
