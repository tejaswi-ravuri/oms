...
// Use the Ledger type from types/ledger
...
export default function LedgersPage() {
  ...
  const handleLedgerSubmit = async (ledgerData) => {
  ...
  // Handle selection
  const handleSelectLedger = (ledgerId, checked) => {
    if (checked) {
  ...
  const getDefaultBusinessLogo = (businessName) => {
